...
namespace PhotoVs.Collision
{
    public class SCollisionResolution : IUpdateableSystem
    {
        ...
        public SCollisionResolution(GameEvents gameEvents, SMapBoundaryGeneration mapBoundary)
        {
        ...
        {
            var stationaryList = new EntityCollection(); //_mapBoundary.GetCollisions());
            var movingList = new EntityCollection();
        ...
        private void Move(IEntity moving, EntityCollection stationaryEntities, GameTime gameTime)
        {
            ...
            foreach (var stationary in stationaryEntities)
            {
                ...
                _gameEvents.Raise("entity:collision", new CollisionGameEventArgs(moving, stationary));
            }
        ...
        private static void ProcessVelocityIntents(IEntity entity)
        {
