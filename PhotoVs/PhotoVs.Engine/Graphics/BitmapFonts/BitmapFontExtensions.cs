...
namespace PhotoVs.Engine.Graphics.BitmapFonts
{
    public static class BitmapFontExtensions
    {
        ...
        public static void DrawString(this SpriteBatch spriteBatch, BitmapFont font, string text, Vector2 position,
            ...
            Rectangle? clippingRectangle = null)
        {
            spriteBatch.DrawString(font, text, position, color, rotation, origin, new Vector2(scale, scale), effect,
        ...
        public static void DrawStringCenterTopAligned(this SpriteBatch spriteBatch, BitmapFont font, string text,
            Vector2 anchor,
            Color color)
        {
            var pos = anchor;
