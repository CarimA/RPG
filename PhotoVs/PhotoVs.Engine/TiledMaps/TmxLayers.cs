...
{
    internal static class TmxLayers
    {
        ...
        private static void WriteCSV(this XmlWriter writer, TileLayer layer)
        {
        ...
        private static void WriteBase64(this XmlWriter writer, TileLayer layer)
        {
