...
using PhotoVs.Graphics.TextureAtlases;

namespace PhotoVs.Graphics.BitmapFonts
{
    public static class BitmapFontExtensions
    {
            ...
            Rectangle? clippingRectangle = null)
        {
            ...
            foreach (var glyph in glyphs)
            {
                ...
                spriteBatch.Draw(glyph.FontRegion.TextureRegion, position, color, rotation, characterOrigin, scale,
                    effect, layerDepth, clippingRectangle);
            }
        }
        ...
        public static void DrawString(this SpriteBatch spriteBatch, BitmapFont font, string text, Vector2 position,
            ...
            Rectangle? clippingRectangle = null)
        {
            DrawString(spriteBatch, font, text, position, color, rotation, origin, new Vector2(scale, scale), effect,
                layerDepth, clippingRectangle);
        }
        ...
        {
            DrawString(spriteBatch, font, text, position, color, 0, Vector2.Zero, Vector2.One, SpriteEffects.None,
                layerDepth, clippingRectangle);
        }
