...
namespace PhotoVs.Logic.BuildTools
{
    internal class MapBaker2
    {
        ...
        // MapBaker3 ideas (only do this if the supertileset gets too big):
        //  - instead, render the map mask/fringe to rendertargets directly, dividing into chunks, save to textures, and divide up the tiles
        ...
        //      - merge the buckets
        //      - remove duplicates (with each bucket already processed for duplicates, this step should take less time)
        //  - export a supertileset
        //  - export the maps pointing to locations on the supertileset
        // experiment with 4x4, 8x8 and 16x16 tile sizes, 8x8 would probably be the best sweet-spot
