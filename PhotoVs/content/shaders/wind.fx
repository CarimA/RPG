...
float4 main(VertexShaderOutput input) : COLOR
{
    ...
    float2 pos = uv + float2(nwaveAmp * sin((1.0 / waveFreq) * ((time * nwaveSpeed) + 1.5 * PI * input.TextureCoordinates.y)), nwaveAmp * cos((1.0 / waveFreq) * ((time * nwaveSpeed) + 1.5 * PI * input.TextureCoordinates.x)));
